package com.gateway.gateway.jwt.security;
...
import static com.gateway.gateway.jwt.security.PublicRoutes.*; //importa las rutas publicas de jwt
import static com.gateway.gateway.redireccion.gestion.GestionPublicRoutes.*; //importa las rutas publicas de API Gateway
import static com.gateway.gateway.redireccion.productos.ProductosPublicRoutes.*; //importa las rutas publicas de API Productos
import static com.gateway.gateway.redireccion.clientes.ClientesPublicRoutes.*; //importa las rutas publicas de API Clientes
