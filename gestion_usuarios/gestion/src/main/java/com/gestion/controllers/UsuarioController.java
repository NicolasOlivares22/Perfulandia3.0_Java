...
public class UsuarioController {
    ...
    public UsuarioDTO obtenerHATEOAS(@PathVariable Integer id) {
        ...
        dto.add(Link.of("http://localhost:8081/api/proxy/usuarios/" + dto.getIdUsuario()).withSelfRel());
        dto.add(Link.of("http://localhost:8081/api/proxy/usuarios/" + dto.getIdUsuario())
    ...
    public List<UsuarioDTO> obtenerTodosHATEOAS() {
        ...
        for (UsuarioDTO dto : lista) {
            ...
            dto.add(Link.of("http://localhost:8081/api/proxy/usuarios").withRel("Get todos HATEOAS"));
            dto.add(Link.of("http://localhost:8081/api/proxy/usuarios/" + dto.getIdUsuario())
